...
const transactionLogger = require('pome-logger').getLogger('transaction-log', __filename);
const transactionErrorLogger = require('pome-logger').getLogger('transaction-error-log', __filename);
