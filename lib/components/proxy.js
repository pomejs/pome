...
const Client = require('pome-rpc').client;
...
class Proxy
{
	...
	start(cb)
    {
        ...
        {
			logger.warn('enableRpcLog is deprecated, please use app.rpcFilter(pome.rpcFilters.rpcLog())');
		}
...
module.exports = function(app, opts)
{
	...
	if (app.enabled('rpcDebugLog'))
	{
		...
		opts.rpcLogger = require('pome-logger').getLogger('rpc-debug', __filename);
	}
